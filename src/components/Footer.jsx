const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-[#D2B48C] text-base-content">
                <nav>
            ...
            <footer className="footer px-10 py-4 border-t bg-[#f1a849] text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>AdventureAxis Ltd. <br />Providing reliable tech since 1992</p>
                </aside>
